...
| `nut-usage-audit.md` | Cross-component NUT mechanism usage and fidelity | F-20 – F-22, F-24, F-37, F-39 | NUT Server / upsd; Node Agent / DaemonSet; Telemetry & Triggers |
...
| F | Audit finding | audit records (`docs/audits/`) | F-1 – F-39 (2026-08-08) |
