...
| [Shared VM framework](vm-test-framework.md) | Source-grounded duplication inventory, module contracts, extraction decisions, and incremental adoption sequence | [Completed VM-12 foundations](../../tasks-completed.md#vm-test-coverage); [VM-8 migration](../../tasks.md#vm-test-coverage) |
