...
func main() {
	...
	flag.BoolVar(&enableLeaderElection, "leader-elect", true,
		"Enable leader election for controller manager. "+
			...
			"Defaults to true: running more than one active manager against the same cluster means "+
			"duplicate reconciles and duplicate orchestrated shutdown actions, so this should only be "+
			"disabled for local single-process development.")
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "ff0f6559.zalud.io",
