...
// "effectively unreachable" through real inputs (Match/MatchPDU only ever hash a matched
// Profile: plain strings, string slices, and maps), so this tests the mechanism directly with a
// value that can fail, rather than trying to manufacture an unreachable real Profile that does.
